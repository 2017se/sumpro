...
<HR style="FILTER: progid:DXImageTransform.Microsoft.Shadow(color:#987cb9,direction:145,strength:15)" width="100%" color=#987cb9 SIZE=1>   <!-- 分割线 -->
         ...
         <div class="nav">
            <ul>
                <div class="box1"><font size="4" color="DarkOrchid">推荐模板</font> </div>
...
<HR style="FILTER: progid:DXImageTransform.Microsoft.Shadow(color:#987cb9,direction:145,strength:15)" width="100%" color=#987cb9 SIZE=1> <!-- 分割线 -->
                ...
                <li class="active highlight"><a href="#"><font size="4" color="DarkOrchid">我的收藏</font></a>
          </ul>
	                 	  ...
	                 	  <ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
		                    ...
		                    <li> 
		                        ...
		                        <div class="product_info">
		                            <small>&nbsp&nbsp&nbsp模板名称</small> </div>
